...
<meta charset="UTF-8">
    ...
    <title>SteerHubIT - Frequently Asked Questions</title>
    <!-- rt icons -->
                    ...
                    <div class="accordion accordion-flush d-flex flex-column gap-4 style__one" id="rts__accordion">
                        ...
                        <div class="accordion-item border-0">
                            <h2 class="accordion-header">
                                <button class="accordion-button p-4 fw-medium border focus-none font-20" type="button" data-bs-toggle="collapse" data-bs-target="#item_one" aria-expanded="true" aria-controls="item_one">
                                What types of healthcare jobs do you offer?
                                </button>
                            </h2>
                            <div id="item_one" class="accordion-collapse border mt-3 collapse show" data-bs-parent="#rts__accordion">
                                <div class="accordion-body">We offer a range of healthcare jobs, including nursing, allied health, and healthcare leadership positions.</div>
                            </div>
                        </div>
                        <div class="accordion-item border-0">
                            <h2 class="accordion-header">
                                <button class="accordion-button p-4 fw-medium border font-20 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#item_two" aria-expanded="false" aria-controls="item_two">
                                How do I apply for a job?
                                </button>
                            </h2>
                            <div id="item_two" class="accordion-collapse border mt-3 collapse" data-bs-parent="#rts__accordion">
                                <div class="accordion-body">You can apply for a job through our website, by uploading your resume and filling out our online application.</div>
                            </div>
                        </div>
                        <div class="accordion-item border-0">
                            <h2 class="accordion-header">
                                <button class="accordion-button p-4 fw-medium border font-20 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#item_three" aria-expanded="false" aria-controls="item_three">
                                What is the pay rate for healthcare professionals?
                                </button>
                            </h2>
                            <div id="item_three" class="accordion-collapse border mt-3 collapse" data-bs-parent="#rts__accordion">
                                <div class="accordion-body">Pay rates vary depending on the job, location, and level of experience. We offer competitive pay rates and benefits.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item border-0">
                            <h2 class="accordion-header">
                                <button class="accordion-button p-4 fw-medium border font-20 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#item_four" aria-expanded="false" aria-controls="item_four">
                                Do you offer benefits?
                                </button>
                            </h2>
                            <div id="item_four" class="accordion-collapse border mt-3 collapse" data-bs-parent="#rts__accordion2">
                                <div class="accordion-body">Yes, we offer a range of benefits, including health insurance, dental insurance, and vision insurance.</div>
                            </div>
                        </div>
                        <div class="accordion-item border-0">
                            <h2 class="accordion-header">
                                <button class="accordion-button p-4 fw-medium border font-20 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#item_five" aria-expanded="false" aria-controls="item_five">
                                How do I get certified or licensed?
                                </button>
                            </h2>
                            <div id="item_five" class="accordion-collapse border mt-3 collapse" data-bs-parent="#rts__accordion2">
                                <div class="accordion-body">We can provide guidance on certification and licensure requirements. Contact us for more information.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item border-0">
                            <h2 class="accordion-header">
                                <button class="accordion-button p-4 fw-medium border font-20 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#item_six" aria-expanded="false" aria-controls="item_six">
                                What types of healthcare staffing services do you offer?
                                </button>
                            </h2>
                            <div id="item_six" class="accordion-collapse border mt-3 collapse" data-bs-parent="#rts__accordion2">
                                <div class="accordion-body">We offer a range of staffing services, including temporary, permanent, and travel staffing.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item border-0">
                            ...
                            <div id="item_six" class="accordion-collapse border mt-3 collapse" data-bs-parent="#rts__accordion2">
                                <div class="accordion-body">You can request staffing support by contacting us through our website or by calling our office.
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="accordion accordion-flush d-flex flex-column gap-4 style__one" id="rts__accordion2">
                        ...
                        <div class="accordion-item border-0">
                            ...
                            <div id="item_six" class="accordion-collapse border mt-3 collapse" data-bs-parent="#rts__accordion2">
                                <div class="accordion-body">The cost of our staffing services varies depending on the type of staffing support needed and the location. Contact us for a customized quote.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item border-0">
                            <h2 class="accordion-header">
                                <button class="accordion-button p-4 fw-medium border font-20 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#item_six" aria-expanded="false" aria-controls="item_six">
                                How do you ensure the quality of your healthcare professionals?
                                </button>
                            </h2>
                            <div id="item_six" class="accordion-collapse border mt-3 collapse" data-bs-parent="#rts__accordion2">
                                <div class="accordion-body">We thoroughly screen and credential all of our healthcare professionals to ensure they meet our high standards.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item border-0">
                            <h2 class="accordion-header">
                                <button class="accordion-button p-4 fw-medium border font-20 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#item_six" aria-expanded="false" aria-controls="item_six">
                                Do you offer customized staffing solutions?
                                </button>
                            </h2>
                            <div id="item_six" class="accordion-collapse border mt-3 collapse" data-bs-parent="#rts__accordion2">
                                <div class="accordion-body">Yes, we offer customized staffing solutions tailored to meet the unique needs of your healthcare facility.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item border-0">
                            ...
                            <div id="item_six" class="accordion-collapse border mt-3 collapse" data-bs-parent="#rts__accordion2">
                                <div class="accordion-body">We serve [list specific areas, e.g., metropolitan areas, states, regions].
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item border-0">
                            ...
                            <div id="item_six" class="accordion-collapse border mt-3 collapse" data-bs-parent="#rts__accordion2">
                                <div class="accordion-body">You can contact us through our website, by phone, or by email.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item border-0">
                            ...
                            <div id="item_six" class="accordion-collapse border mt-3 collapse" data-bs-parent="#rts__accordion2">
                                <div class="accordion-body">Our business hours are [list specific hours].
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item border-0">
                            ...
                            <div id="item_six" class="accordion-collapse border mt-3 collapse" data-bs-parent="#rts__accordion2">
                                <div class="accordion-body">Yes, we are [list certifications or accreditations, e.g., Joint Commission certified].
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item border-0">
                            ...
                            <div id="item_six" class="accordion-collapse border mt-3 collapse" data-bs-parent="#rts__accordion2">
                                <div class="accordion-body">We take all complaints and concerns seriously and have a formal process in place to address them. Contact us for more information.
                                </div>
                            </div>
                        </div>
