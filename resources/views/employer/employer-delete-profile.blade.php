...
<meta charset="UTF-8">
    ...
    <title>Delete Account - SteerHubIT</title>
    <!-- rt icons -->
                ...
                <div class="candidate__passwordchange">
                    ...
                    <div class="change__password">
                        <div class="password__change__form">
                            ...
                            <div id="messages"></div>
                            <form id="delete-employer-account" method="POST" action="">
                                @csrf
                                <!-- single item -->
                                <div class="rts-input-group">
                                    <label for="currentPassword">Please Enter Your Login Password</label>
                                    <div class="input-box">
                                        <input type="password" name="currentPassword" id="currentPassword" placeholder="Enter your current password" autocomplete="off">
                                    ...
                                    <small id="error-currentPassword" style="color: red !important;"></small>
                                </div>
                                <!-- single item end -->
                                 <div class="d-flex justify-content-end gap-30">
                                    <button type="button" onclick="window.history.back();" class="cancel__buttonh rts__btn gray__btn">Cancel</button>
...
<script src="{{ asset('assets/js/delete-employer-account.js') }}"></script>
