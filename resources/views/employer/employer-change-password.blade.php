...
<meta charset="UTF-8">
    ...
    <title>Change Password - SteerHubIT</title>
    <!-- rt icons -->
                ...
                <div class="candidate__passwordchange">
                    ...
                    <div class="change__password">
                        <div class="password__change__form">
                            <h6 class="text-center fw-semibold mb-30">Change Password</h6>
                            ...
                            <form id="change-password-form" method="POST" action="#">
                                ...
                                <div class="rts-input-group">
                                    ...
                                    <small id="error-newPassword" style="color: red !important;"></small>
                                </div>
                                <!-- single item end -->
                                <!-- single item -->
                                <div class="rts-input-group">
                                    ...
                                    <small id="error-retypePassword" style="color: red !important;"></small>
                                </div>
                                <!-- single item end -->
...
<script src="{{ asset('assets/js/emp-update-password.js') }}"></script>
</body>
</html>