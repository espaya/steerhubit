                           ...
                           <div class="user__info">
                              <div class="d-flex gap-3 align-items-center pointer" data-bs-toggle="dropdown">
                                 <div class="user__image">
                                    <img id="header-avatar" class="rounded-5" width="48" height="48" src="{{ Auth::user()->avatar ? asset('uploads/avatars/' . Auth::user()->avatar) : asset('assets/img/dashboard/profile.png') }}" alt="">
                                 </div>
