...
<head>
   ...
   <link rel="canonical" href="{{ route('employee') }}">
   <meta name="robots" content="index, follow">
   <!-- for open graph social media -->
   <meta property="og:title" content="Employee Dashboard - SteerHubIT">
   ...
   <meta property="og:url" content="{{ route('employee') }}">
   <!-- for twitter sharing -->
   <meta name="twitter:card" content="summary_large_image">
   <meta name="twitter:title" content="Employee Dashboard - SteerHubIT">
   ...
   <title>Employee Dashboard - SteerHubIT</title>
   <!-- rt icons -->
            ...
            <div class="dash__overview">
               ...
               <div class="overview__content">
                  <div class="single__overview">
                     ...
                     <div class="content">
                        <h5 class="lh-sm">{{ $total_applied_jobs ? $total_applied_jobs : $total_applied_jobs  }}</h5>
