                ...
                <div class="candidate__passwordchange">
                    ...
                    <div class="change__password">
                        <div class="password__change__form">
                            ...
                            <form action="{{ route('employee.delete-profile.delete') }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <!-- single item -->
                                <div class="rts-input-group">
                                    ...
                                    <div class="input-box">
                                        <input autocomplete="off" type="password" name="password" id="currentPassword" placeholder="Enter your current password">
                                ...
                                <!-- single item end -->
                                 <div class="d-flex justify-content-end gap-30">
                                    <button onclick="window.history.back();" class="cancel__buttonh rts__btn gray__btn">Cancel</button>
                                     <button onclick="return confirm('Deleting your account will permanently erase all your data at SteerHubIt. Are you sure you want to proceed?')" type="submit" class="rts__btn fill__btn">Delete Profile</button>
                                 </div>
                                 @error('password')
