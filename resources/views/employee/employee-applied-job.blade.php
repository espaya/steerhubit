                    ...
                    <div class="applied__job__list">
                        ...
                        <div class="single__applied__job">
                            <div class="single__applied__job__content">   
                                <div class="icon">
                                    <img src="{{ $job->user->avatar ? asset('uploads/avatars/' . $job->user->avatar) : asset('assets/img/dashboard/profile.png')}}" alt="">
                                </div>
                                <div class="content__flex">
                                    <div class="content">
                                        <a href="{{ route('job.view', ['slug' => $job->slug]) }}"> <h6>{{ $job->title }}</h6></a>
                                        <div class="content__info">
                                            <span><i class="fa-light fa-location-dot"></i> {{ $job->address . ', ' . $job->country }}</span>
                            ...
                            <div class="action">
                                <a href="{{ route('job.view', ['slug' => $job->slug]) }}" class="action__btn">
                                ...
                                <form onclick="return confirm('Are you sure you want to remove this job?')" action="#" method="post">
                        ...
                        <div class="rts__pagination d-block mx-auto pt-40 max-content">
                            <ul class="d-flex gap-2">
                                ...
                                @foreach ($jobs->getUrlRange(1, $jobs->lastPage()) as $page => $url)
                                    <li>
                                        <a href="{{ $url }}" class="{{ $jobs->currentPage() == $page ? 'active' : '' }}">
                                            {{ $page }}
                                        </a>
                                    </li>
                                @endforeach
