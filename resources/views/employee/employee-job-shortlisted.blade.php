...
<meta charset="UTF-8">
    ...
    <title>SteerHubIT - Job Shortlisted</title>
    <!-- rt icons -->
                    ...
                    <div class="applied__job__list">
                        ...
                        <div class="single__applied__job">
                            <div class="single__applied__job__content">   
                                ...
                                <div class="content">
                                    <a href="#"> <h6>Senior UI Designer, Google</h6></a>
                                    <div class="content__info">
                                        <span><i class="fa-light fa-location-dot"></i> Newyork, USA</span>
                                        <span><i class="fa-light fa-briefcase"></i>Full Time</span>
                                        <span><i class="fa-light fa-clock"></i> 1 Year Ago</span>
                        ...
                        <div class="single__applied__job">
                            <div class="single__applied__job__content">   
                                ...
                                <div class="content">
                                    <a href="#"> <h6>Senior Software Engineer, Upwork</h6></a>
                                    <div class="content__info">
                                        <span><i class="fa-light fa-location-dot"></i> Newyork, USA</span>
                                        <span><i class="fa-light fa-briefcase"></i>Full Time</span>
                                        <span><i class="fa-light fa-clock"></i> 1 Year Ago</span>
                                ...
                                <div class="tags">
                                    <a href="#"> <span class="tag">Creative</span></a>
                                    <a href="#"> <span class="tag">Web Development</span></a>
                                    <a href="#"> <span class="tag">PHP</span></a>
                                </div>
                            </div>
                            <div class="action">
                                <button class="action__btn">
                        ...
                        <div class="single__applied__job">
                            <div class="single__applied__job__content">   
                                ...
                                <div class="content">
                                    <a href="#"> <h6>Senior UI Designer, Bing</h6></a>
                                    <div class="content__info">
                                        <span><i class="fa-light fa-location-dot"></i> Newyork, USA</span>
                                        <span><i class="fa-light fa-briefcase"></i>Full Time</span>
                                        <span><i class="fa-light fa-clock"></i> 1 Year Ago</span>
                        ...
                        <div class="single__applied__job">
                            <div class="single__applied__job__content">   
                                ...
                                <div class="content">
                                    <a href="#"> <h6>Marketing Manager, Facebook</h6></a>
                                    <div class="content__info">
                                        <span><i class="fa-light fa-location-dot"></i> Newyork, USA</span>
                                        <span><i class="fa-light fa-briefcase"></i>Full Time</span>
                                        <span><i class="fa-light fa-clock"></i> 1 Year Ago</span>
                                ...
                                <div class="tags">
                                    <a href="#"> <span class="tag">Creative</span></a>
                                    <a href="#"> <span class="tag">User Interface</span></a>
                                    <a href="#"> <span class="tag">Ads</span></a>
                                </div>
                            </div>
                            <div class="action">
                                <button class="action__btn">
