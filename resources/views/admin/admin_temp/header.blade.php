<header class="header-top">
        <nav class="navbar navbar-light">
            <div class="navbar-left">
                ...
                <a class="navbar-brand" href="#"><img class="dark" src="{{asset('assets/img/logo/logo.png')}}" alt="svg"><img class="light" src="{{asset('assets/img/logo/logo.png')}}" alt="img"></a>
                        ...
                        <div class="dropdown-custom">
                            ...
                            <div class="dropdown-wrapper">
                                ...
                                <div class="nav-author__options">
                                    ...
                                    <a href="#"  onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="nav-author__signout">
