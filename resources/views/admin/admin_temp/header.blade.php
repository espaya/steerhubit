        ...
        <nav class="navbar navbar-light">
            <div class="navbar-left">
                <a href="" class="sidebar-toggle">
                    <img class="svg" src="{{asset('assets/mgt/img/svg/bars.svg')}}" alt="img"></a>
                <a class="navbar-brand" href="#"><img class="dark" src="{{asset('assets/mgt/img/logo_dark.png')}}" alt="svg"><img class="light" src="{{asset('assets/mgt/img/logo_white.png')}}" alt="img"></a>
                        ...
                        <ul>
                            <li class="has-subMenu">
                                ...
                                <ul class="subMenu">
                                    ...
                                    <li>
                                        <a class="active" href="business.html">FineTech /
                                            Business</a>
                                    </li>
                                    <li>
            ...
            <div class="navbar-right">
                <ul class="navbar-right__menu">
                    ...
                    <li class="nav-author">
                        <div class="dropdown-custom">
                            <a href="javascript:;" class="nav-item-toggle"><img src="{{asset('assets/mgt/img/author-nav.jpg')}}" alt="" class="rounded-circle"></a>
                            <div class="dropdown-wrapper">
                                <div class="nav-author__info">
                                    <div class="author-img">
                                        <img src="{{asset('/assets/mgt/img/author-nav.jpg')}}" alt="" class="rounded-circle">
                                    </div>
                                    <div>
